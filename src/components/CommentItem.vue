      ...
      <div class="comment-actions">
        <div class="rating-buttons">
          ...
          <button
            ...
            @click="rateComment(-1)"
          >
            <AppIcon name="thumbsDown" :size="15" />
          </button>
        </div>
